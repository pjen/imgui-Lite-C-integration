...
DLLFUNC var imgui_slider_angle(char *label, float *v_rad, float v_degrees_min, float v_degrees_max)
{
	bool res = ImGui::SliderAngle(label, v_rad, v_degrees_min, v_degrees_max);
	return res ? _VAR(1) : _VAR(0);
}
